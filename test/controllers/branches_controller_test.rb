...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, city: @branch.city, country: @branch.country, name: @branch.name, state: @branch.state, store_id: @branch.store_id, zip: @branch.zip }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, city: @branch.city, country: @branch.country, name: @branch.name, state: @branch.state, store_id: @branch.store_id, zip: @branch.zip }
    assert_redirected_to branch_path(assigns(:branch))
  end
