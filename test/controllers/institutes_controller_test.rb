...
class InstitutesControllerTest < ActionController::TestCase
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post :create, institute: { description: @institute.description, image: @institute.image, name: @institute.name, user_id: @institute.user_id }
    end
  ...
  test "should update institute" do
    patch :update, id: @institute, institute: { description: @institute.description, image: @institute.image, name: @institute.name, user_id: @institute.user_id }
    assert_redirected_to institute_path(assigns(:institute))
  end
