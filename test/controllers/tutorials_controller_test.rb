...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { end_date: @tutorial.end_date, image: @tutorial.image, start_date: @tutorial.start_date, title: @tutorial.title, user_id: @tutorial.user_id, web_link: @tutorial.web_link }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { end_date: @tutorial.end_date, image: @tutorial.image, start_date: @tutorial.start_date, title: @tutorial.title, user_id: @tutorial.user_id, web_link: @tutorial.web_link }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
